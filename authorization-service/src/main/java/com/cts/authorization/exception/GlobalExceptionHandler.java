...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 *
	 * @param invalidCredentialsException - Exception thrown when invalid credentials are fed
	 * @return Response Entity of custom type Error Response with error message and
	 *         time-stamp
	 */
	@ExceptionHandler(InvalidCredentialsException.class)
	public ResponseEntity<ErrorResponse> handlesUserNotFoundException(InvalidCredentialsException invalidCredentialsException) {
	 ...
	 *
	 * @param invalidTokenException - exception thrown when an invalid token is passed
	 * @return Response Entity of custom type Error Response with error message and
	 *         time-stamp
	 */
